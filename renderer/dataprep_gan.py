...
class prep(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        i = torch.randint(low = 0, high = 8, size = (1,1))
        j = torch.randint(low = 8, high = 40, size = (1,1))
